...
switch (_var) do
{
	...
	case "life_inv_blastingcharge": {"Explosif"};
	case "life_inv_boltcutter": {"Force serrure"};
	...
	case "life_inv_raisin": {"Grappe de Raisin"};
    case "life_inv_moonshine": {"moonshine"};
    case "life_inv_barrier": {"Barrière"};
    ...
    // TDLC Ajout object
	case "life_tdlc_biere": {"biere"};
	case "life_tdlc_malt": {"malt"};
	case "life_tdlc_houblon": {"houblon"};
	
	case "life_tdlc_bois": {"Tronc"};
	case "life_tdlc_papier": {"Kg de papier"};
	case "life_tdlc_fauxbillet": {"Kg de Faux billet"};
	
	case "life_tdlc_hache": {"Hache"};
	case "life_inv_Zip": {"Serflex"};
    ...
    //Gosh
    case "license_civ_vin": {"Viticulteur"};
    case "license_civ_moonshine": {"Distilleur de moonshine"};
    case "license_civ_mineralogiste": {"Minéralogiste"};
	
	// TDLC Ajout license
	case "license_biere": {"Brasseur"};
	case "license_bois": {"Bucheron"};
	case "license_bois2": {"Imprimerie"};
	case "license_civ_admin": {"Admin"};
