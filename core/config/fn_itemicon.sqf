...
switch (_var) do
{
	...
	case "life_inv_tbacon": {("icons\items\cannedfood.paa")};
    ...
    case "life_inv_vin": {("icons\items\vin.paa")};
    case "life_inv_moonshine": {("icons\items\moonshine.paa")};
    case "life_inv_barrier": {("icons\items\mauer.paa")};
    case "life_tdlc_biere": {("icons\items\beer.paa")};
    case "life_tdlc_bois": {("icons\items\wood.paa")};
    case "life_tdlc_hache": {("icons\items\axe.paa")};
};