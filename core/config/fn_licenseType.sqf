...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			//TDLC
			case "beer": {_var = "license_bierre"};
			case "wood1": {_var = "license_bois"};
			case "wood2": {_var = "license_bois2"};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			//TDLC
			case "license_biere": {_var = "beer"};
			case "license_bois": {_var = "wood1"};
			case "license_bois2": {_var = "wood2"};
