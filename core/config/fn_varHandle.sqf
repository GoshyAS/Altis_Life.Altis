...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			//TDLC
			case "biere": {"life_tdlc_biere"};
			case "malt": {"life_tdlc_malt"};
			case "houblon": {"life_tdlc_houblon"};
			
			case "bois": {"life_tdlc_bois"};
			case "papier": {"life_tdlc_papier"};
			case "fauxbillet": {"life_tdlc_fauxbillet"};
			
			case "hache": {"life_tdlc_hache"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_tdlc_bois": {"bois"};
			case "life_tdlc_papier": {"papier"};
			case "life_tdlc_fauxbillet": {"fauxbillet"};
