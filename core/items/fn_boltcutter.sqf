...
if(isNull _building) exitWith {hint "rien de detecté";};
if(!(_building isKindOf "House_F")) exitWith {hint "You are not looking at a house door."};
if(isNil "life_boltcutter_uses") then {life_boltcutter_uses = 0;};
if((nearestObject [[12426,14098.7,0],"Land_Offices_01_V1_F"]) == _building OR (nearestObject [[12426,14098.7,0],"Land_Offices_01_V1_F"]) == _building) then { //if((nearestObject [[16019.5,16952.9,0],"Land_Dome_Big_F"]) == _building OR (nearestObject [[16019.5,16952.9,0],"Land_Research_house_V1_F"]) == _building) then {
...
switch (typeOf _building) do {
	case "Land_Offices_01_V1_F": {_cpRate = 0.015;};
