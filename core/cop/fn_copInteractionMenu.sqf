...
if(!((player distance (getMarkerPos "police_hq_1") < 50) OR  (player distance (getMarkerPos "cop_spawn_2") < 80) OR (player distance (getMarkerPos "cop_spawn_3") < 80) OR (player distance (getMarkerPos "cop_spawn_1") < 80))) then 
{
