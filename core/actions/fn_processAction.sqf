...
_itemInfo = switch (_type) do
{
    ...
    //Gosh
    case "vin": {["raisin","vin",2500,"Mise en bouteille...."];};
	case "moonshine": {["raisin","moonshine",3500,"Mise en bouteille...."];};
	
	// TDLC
	case "wood1": {["bois","papier",500,"Traitement en cours..."];};
	case "wood2": {["papier","fauxbillet",2500,"Traitement en cours..."];};
	default {[];};
};
